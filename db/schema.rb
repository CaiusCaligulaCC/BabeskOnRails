...
ActiveRecord::Schema.define(version: 20140423185412) do
  ...
  create_table "kuwasys_categories", force: true do |t|
  ...
  create_table "kuwasys_registrations", force: true do |t|
    t.integer  "user_id"
    t.integer  "course_id"
    t.integer  "status_id"
    t.datetime "created_at"
  ...
  create_table "kuwasys_statuses", force: true do |t|
